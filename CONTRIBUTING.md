...
Thanks for helping maintain WP Term Icons.
...
[GitHub Security Advisories](https://github.com/stuttter/wp-term-icons/security/advisories/new).
...
- Exercise add, edit, quick-edit, and programmatic term updates when changing
  metadata writes.
- Exercise initial, selected, changed, and cleared states when changing the
  icon picker.
- Identify taxonomy-query, accessibility, dependency, automation, and release
